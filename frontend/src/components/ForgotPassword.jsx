...
export default function ForgotPassword({ onBack }) {
  ...
  return (
    <div className="flex flex-1 items-center justify-center p-8 z-10 w-full relative min-h-screen py-12 overflow-hidden" style={{ backgroundColor: '#ffffff' }}>
      ...
      <div className="bg-dark-900/95 backdrop-blur-md p-8 w-full max-w-md glow-ring animate-fade-in z-10 relative rounded-2xl border border-dark-700 shadow-2xl">
            ...
            {step === 3 && (
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input type={showPassword ? "text" : "password"} value={newPassword} onChange={e=>setNewPassword(e.target.value)} required className="input-field py-2.5 text-base w-full pr-10" autoFocus />
