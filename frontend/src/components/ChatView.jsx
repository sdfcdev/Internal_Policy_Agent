      ...
      <div className="px-4 sm:px-8 py-6 border-t border-white/5 bg-dark-900/80 backdrop-blur-xl shrink-0">
        <div className="max-w-4xl mx-auto">
          <form onSubmit={handleSend} className="flex items-center gap-3 w-full">
            <div className="flex-1 relative group">
              <input 
                ...
                placeholder={hint} 
                disabled={loading} 
                className="input-field w-full text-sm py-3.5 px-5 bg-white/5 border-white/10 focus:border-brand-500/50 transition-all rounded-2xl" 
              />
              <button 
                type="button"
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mt-4 px-2">
             <p className="text-[10px] text-slate-500 font-medium">SDF AI Copilot can make mistakes. Verify critical information.</p>
