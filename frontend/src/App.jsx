...
function LoginScreen({ onLogin, onForgotPassword, onRegister }) {
  ...
  return (
    ...
    >
      {/* Overlay to darken and blur the background image slightly so the login box pops, but kept light enough so the image is clearly visible */}
      <div className="absolute inset-0 bg-dark-900/20 backdrop-blur-[2px] z-0 pointer-events-none"></div>
